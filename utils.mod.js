...
Utils.getDistanceBetweenTwoPoints = (x0,y0,z0, x1,y1,z1) => {
...
Utils.getMidPointBetweenTwoPoints = (x0,y0,z0, x1,y1,z1) => {
    var x = (x0 + x1) / 2;
    var y = (y0 + y1) / 2;
    var z = (z0 + z1) / 2;
...
Utils.getUniqueValuesInArray = (array) =>
{
    var uniqueArray = [];
    var count = 0;
...
Utils.eliminateDuplicatesInArray = (array) =>
{
...
Utils.getVectorBetweenTwoPoints = (x0,y0,z0, x1,y1,z1) =>
{
...
Utils.getNormalizedVectorBetweenTwoPoints = (x0,y0,z0, x1,y1,z1) =>
{
...
Utils.crossProductVector = (vector0, vector1) =>
{
...
Utils.multiplyVectorByQuaternion = (vectorX, vectorY, vectorZ, quatX, quatY, quatZ, quatW) =>
{
...
// scale a vector
Utils.scaleVector = (vector, scalar) =>
{
...
Utils.dotProductVector = (vector0, vector1) =>
{
...
Utils.angleBetweenVectors = (vector0, vector1) =>
{
...
Utils.angleBetween2DVectors = (vector0, vector1) =>
{
